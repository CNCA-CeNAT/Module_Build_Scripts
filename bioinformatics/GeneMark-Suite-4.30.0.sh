...
cp ./* ${prefix}
mkdir -p /opt/bioinf/modulefiles/GeneMarkSuite

/bin/cat <<"#EOF#" > /opt/bioinf/modulefiles/GeneMarkSuite/4.30.0
#%Module#####################################################################
## netcdf-
set version 4.30.0
proc ModulesHelp { } {
...
set prefix /opt/bioinf/genemark_suite_linux_64
...
/bin/cat <<"#EOF#" > /opt/bioinf/modulefiles/GeneMarkSuite/.modulerc
#%Module
