...
src=/opt/src
prefix=/opt/bioinf/RepeatMasker
cd $src
mkdir -p $prefix
...
mkdir -p /opt/bioinf/modulefiles/RepeatMasker

/bin/cat <<"#EOF#" > /opt/bioinf/modulefiles/RepeatMasker/4.0.6
#%Module#####################################################################
## RepeatMasker
set version 4.0.6
proc ModulesHelp { } {
...
set prefix /opt/bioinf/RepeatMasker
...
/bin/cat <<"#EOF#" > /opt/bioinf/modulefiles/RepeatMasker/.modulerc
#%Module
