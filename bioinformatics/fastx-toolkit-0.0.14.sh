...
/bin/cat <<"#EOF#" > /opt/bioinf/modulefiles/fastx_toolkit/0.0.14
#%Module#####################################################################
## fastx-toolkit
set version 0.0.14
proc ModulesHelp { } {
...
set prefix /opt/bioinf/fastx_toolkit-${version}
...
/bin/cat <<"#EOF#" > /opt/bioinf/modulefiles/fastx_toolkit/.modulerc
#%Module
