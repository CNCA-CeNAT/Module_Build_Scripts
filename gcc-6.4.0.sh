...
soft=gcc-6.4.0
src=/opt/src
prefix=/opt/compilers/gcc-6.4.0
cd $src
mkdir -p $prefix
wget --quiet http://www.netgull.com/gcc/releases/gcc-6.4.0/gcc-6.4.0.tar.gz
tar -xvzf gcc-6.4.0.tar.gz
...
/bin/cat <<"#EOF#" > /opt/compilers/modulefiles/gcc/6.4.0
#%Module#################################################################
set version 6.4.0
proc ModulesHelp { } {
